...
# python files/conv_flat_images.py ./ ./dumps9 ./dumps5 ./dumps2 ./dumps05
...
for i in range(101):
    ...
    errors.append(find_error(dumpsdir5, i))
    cour_inv.append(1/0.2)
    errors.append(find_error(dumpsdir2, i))
    cour_inv.append(1/0.05)
    errors.append(find_error(dumpsdir05, i))
    #plotting:
    ...
    plt.legend()
    plt.savefig(os.path.join(outputdir9,'error_vs_cour_{0:04d}.png'.format(i)))
    plt.close()