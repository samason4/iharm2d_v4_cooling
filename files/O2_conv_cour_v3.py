...
#errors.append(find_error(dumpsdir7, 12, 32, np.pi/2))
cour_inv.append(1/0.5)
errors.append(find_error(dumpsdir5, 12, 32, np.pi/2))
#cour_inv.append(1/0.4)
#errors.append(find_error(dumpsdir4, 12, 32, np.pi/2))
#find_error(dumpsdir25, 12, 32, np.pi/2)
#find_error(dumpsdir125, 12, 32, np.pi/2)
cour_inv.append(1/0.0625)
errors.append(find_error(dumpsdir0625, 12, 32, np.pi/2))
#find_error(dumpsdir03125, 12, 32, np.pi/2)
